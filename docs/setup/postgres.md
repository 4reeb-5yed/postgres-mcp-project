...
**Connection status**
[![Connected badge](../screenshots/postgres/phase1_connected_badge.png)](../screenshots/postgres/phase1_connected_badge.png)

**Container running**
[![docker ps](../screenshots/postgres/phase1_docker_ps.png)](../screenshots/postgres/phase1_docker_ps.png)

**Prompt 1 — Schema discovery:** *"What columns does the employees table have?"*
[![Schema query](../screenshots/postgres/phase1_query_schema.png)](../screenshots/postgres/phase1_query_schema.png)

**Prompt 2 — Aggregation:** *"What's the average salary by department in the employees table?"*
[![Aggregation query](../screenshots/postgres/phase1_query_aggregation.png)](../screenshots/postgres/phase1_query_aggregation.png)

**Prompt 3 — Query generation:** *"Write and run a query to find the highest-paid employee in the employees table."*
[![Top salary query](../screenshots/postgres/phase1_query_topquery.png)](../screenshots/postgres/phase1_query_topquery.png)
...
[![Codegen query](../screenshots/postgres/phase1_query_codegen.png)](../screenshots/postgres/phase1_query_codegen.png)
